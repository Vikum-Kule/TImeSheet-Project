            ...
            if(!isDeleteProcess){
                ...
                for(line in lines) {
                    ...
                    if (lineCount == 0) {
                        ...
                        name = values[1].split(' ');
                        def userUrl = "https://api.atlassian.com/ex/jira/2eafded6-d1b9-41bd-8b84-6600f92e0032/rest/api/3/user/search?query=${name[0]}+${name[1]}&maxResults=1"
                        ...
                        def leadUrl = "https://api.atlassian.com/ex/jira/2eafded6-d1b9-41bd-8b84-6600f92e0032/rest/api/3/user/search?query=${leadName[0]}+${leadName[1]}"
