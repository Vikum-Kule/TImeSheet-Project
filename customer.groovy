...
def updateTokens(refreshToken, credentialId) {
  ...
  try {
        ...
        def customerResponse = sendGetRequest(customerUrl, requestHeaders, "XERO","8652e9a4-0afe-40b5-8c25-a52da8287fb2","${xeroRefreshBody}${xeroRefreshTokenCred.getSecret()}")
