              ...
              ])
          {
            quoteList.Quotes.each{quote ->
              if(quote.account){
                ...
                filterJson.name = quote.QuoteNumber + " - Filter"
              ...
              ])
            {
              quoteList.Quotes.each{quote ->
                if(quote.account){
                  ...
                  projectJson.name = quote.QuoteNumber + " : " + quote.Title + " - Time"
                  ...
                  projectJson.name = quote.QuoteNumber + " : " + quote.Title + " - Cost"
